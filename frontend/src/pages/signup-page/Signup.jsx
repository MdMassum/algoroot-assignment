      ...
      <div className="flex items-center justify-center bg-white gap-3 p-4 md:p-8 rounded-lg shadow-sm w-[700px] h-[450px]">
        <div className="w-full md:w-1/2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-blue-500 flex items-center justify-center"
              disabled={loading}
            >
