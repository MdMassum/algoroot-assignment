      ...
      <div className="flex items-center justify-center bg-white gap-3 p-4 md:p-8 rounded-lg shadow-sm w-[700px] h-[400px]">
        {isLogin ? <div className="w-full md:w-1/2">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="username">Email/Username</label>
              <input
                type="text"
                id="username"
                value={username}
        ...
        :
          <div className="flex flex-col pr-4 mb-4 min-w-40">
            ...
            <input
              ...
              required
            />
            <button className="w-full bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 flex items-center justify-center" onClick={handleForgotPassword}>{loading ? "Sending..." : "Send Link"}</button>
